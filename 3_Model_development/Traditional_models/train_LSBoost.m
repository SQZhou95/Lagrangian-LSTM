function [Mdl,Y,Y_mean,Y_best_mean,Stat,Stat_Y_mean,Stat_best_mean] = train_LSBoost(X,T,index, NumLearningCycles, MinLeafSize, LearnRate, num_try)
...
for i = 1:num_try  
    % Train the LSBoost tree model
    tree = fitrensemble(X_Train_Validation,T_Train_Validation,"Method",'LSBoost',...
        "NumLearningCycles",NumLearningCycles,"LearnRate",LearnRate, ...
        "Learners",templateTree("MinLeafSize",MinLeafSize,"NumVariablesToSample","all"));
    ...
    disp(['NumLearningCycles: ',num2str(NumLearningCycles),', MinLeafSize: ',num2str(MinLeafSize),', LearnRate: ',num2str(LearnRate)])
